        ...
        <div
              ...
              <div style={{ width: "100%", maxWidth: 400, position: "relative", zIndex: 1, textAlign: "center" }}>
                      <div
                                ...
                                >
                                <span className="dh-serif" style={{ color: "#A18A44", fontSize: 22, fontWeight: 600, letterSpacing: "0.02em", lineHeight: 1 }}>
                                            DH
                                </span>span>
                      </div>div>
                      <p className="dh-sans fade-up fade-up-1" style={{ color: "#A18A44", fontSize: 11, fontWeight: 500, letterSpacing: "0.18em", textTransform: "uppercase", marginBottom: 12 }}>
                                Private Preview
                      </p>p>
                      <h1 className="dh-serif fade-up fade-up-2" style={{ color: "#F5F0E8", fontSize: 36, fontWeight: 600, letterSpacing: "-0.01em", lineHeight: 1.15, marginBottom: 12 }}>
                                Deddeh Hills
                      </h1>h1>
                      <p className="dh-sans fade-up fade-up-2" style={{ color: "rgba(245,240,232,0.45)", fontSize: 14, fontWeight: 400, lineHeight: 1.6, marginBottom: 40 }}>
                                Enter your access code to continue.
                      </p>p>
                      <form onSubmit={handleSubmit} className={`fade-up fade-up-3 ${shake ? "shake" : ""}`} style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                                <input
                                              ref={inputRef}
                                              type="text"
                                              value={code}
                      ...
                      <p className="dh-sans fade-up fade-up-4" style={{ color: "rgba(245,240,232,0.2)", fontSize: 12, marginTop: 40, letterSpacing: "0.02em" }}>
                                Koura, North Lebanon
                      </p>p>
              </div>div>
        </div>div>
